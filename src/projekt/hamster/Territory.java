...
public class Territory
{
	...
	/**
	 * @param fieldString String mit der Textr�ckgabe vom Hamster nach dem init Befehl
	 */
	...
	/**
	 * Pr�ft ob eine Mauer an der Koordinate ist. True wenn ja.
	...
	/**
	 * Gibt die Anzahl der K�rner auf der koordinate wieder
	 * @param row Int Wert der Reihe
	 * @param column Int Wert der Spalte
